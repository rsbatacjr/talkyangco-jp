					...
					<br>
	        			<div class="row">
                            <div class="col-xs-12 col-sm-offset-3 col-sm-3">
        						<button style="border-radius: 10px;border: 1px solid #000; padding: 15px; background-color: transparent;width: 90%;margin-bottom: 15px;" onclick="javascript:$(this).css({'background-color': 'rgb(0,176,240)'});window.location='http://talk-academy.jp/yangco-esl/'">Yangco センター</button>
						    </div>
						    <div class="col-xs-12 col-sm-3">
						        <button style="border-radius: 10px;border: 1px solid #000; padding: 15px; background-color: transparent;width: 90%;margin-bottom: 15px;" onclick="javascript:$(this).css({'background-color': 'rgb(0,176,240)'});window.location='http://talk-academy.jp/ene-center-esl-program/'">ESL プログラム</button>
						    </div>
                        </div>
                        <br>
			<br>
